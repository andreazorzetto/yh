...
Unable to find a YAML highlighter he could simply throw some content at with little to no ~~respect~~ expectation, and full of inspiration from his recent Go training, he decides to write one from scratch.
